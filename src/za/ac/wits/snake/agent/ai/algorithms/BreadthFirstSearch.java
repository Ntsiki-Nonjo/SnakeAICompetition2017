...
public class BreadthFirstSearch {
    ...
    public BreadthFirstSearch(Coords h, Coords a, int length) {
    ...
    public static int move(Coords snakeHead, Coords apple, int[][] playArea) {
        ...
        // SET : BFS variable
        BreadthFirstSearch b = new BreadthFirstSearch(snakeHead, apple, playArea.length);
